...
// The real offices — ONE list, used by the footer and by the contact block on
// every page. Keeping them separate is what let the contact block sit on stale
// addresses while the footer was correct.
export const OFFICES = [
  {
    city: "Head Office",
    label: "Visit Us Daily",
    addr: "Office no. 102 First Floor, H-180, H Block, Sector 63, Noida, Uttar Pradesh 201309",
    isHead: true,
  },
  {
    city: "Jaipur",
    label: "Branch Office",
    addr: "303, Third Floor, Shree G D Tower, Plot NO 3/99, Neel Kanth Colony, Ajmer Road, Jaipur - 302021",
  },
];
